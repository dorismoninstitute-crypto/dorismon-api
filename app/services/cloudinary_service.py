...
SITE_IMAGE_SLOTS = [
    {
        ...
        "description": "La foto grande de arriba, al lado del titular.",
    ...
    {
        "slot": "platform",
        "label": "Captura de la plataforma",
        "hint": "1600 × 1000 px · PNG · menos de 400 KB",
        "description": "Entra como estudiante y toma una captura de pantalla del panel. Muestra que la plataforma es real.",
    ...
    },
    {
        ...
        "description": "El dibujo del bloque azul al final. Si no la subes, el bloque se ve bien igual.",
        "priority": "opcional",
    },
]
