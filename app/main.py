...
from app.routers import ai  # V3.9.31: generar contenido
...
app.include_router(push.router)  # V3.9.29
app.include_router(ai.router)  # V3.9.31  # V3.1 — centro de avisos universal
